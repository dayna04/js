...
class toyforestScene extends Phaser.Scene {
  ...
  create() {
    resetGameGlobals(); // <-- reset all counters at the start
...
window.toysCollected = 0;
this.toyText = this.add.text(630, 70, `Toys: ${window.toysCollected}/10`, {
  fontFamily: "christmaspix",
  fontSize: "25px",
  fill: "#fff9e6",
  stroke: "#352f0a",
